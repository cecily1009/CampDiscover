...
// Reviews Edit
router.get("/:review_id/edit", middleware.isReviewAuthorized, function (req, res) {
...
// Reviews Update
router.put("/:review_id", middleware.isReviewAuthorized, function (req, res) {
...
// Reviews Delete
router.delete("/:review_id", middleware.isReviewAuthorized, function (req, res) {
